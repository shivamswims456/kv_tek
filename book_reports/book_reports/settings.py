"""
Django settings for book_reports project.
...
SECRET_KEY = 'django-insecure-6a1c32^8u#2wk&o8su*ol-yoej6!_(&fcj5-omok*!yu7b%s$!'
...
ROOT_URLCONF = 'book_reports.urls'
...
WSGI_APPLICATION = 'book_reports.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'OPTIONS':{
            ...
            'read_default_file':os.path.join(BASE_DIR, 'conf', 'db',  'sql.cnf')
